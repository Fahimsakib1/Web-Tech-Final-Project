...
<?php 
...

					{
					    ...
					    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020june"; 
...

                        {
						    ...
						    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020june";  // Query

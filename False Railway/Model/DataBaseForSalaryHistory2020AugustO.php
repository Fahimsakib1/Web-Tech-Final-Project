...
<?php 
...

					{
					    ...
					    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020august"; 
...

                        {
						    ...
						    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020august";  // Query

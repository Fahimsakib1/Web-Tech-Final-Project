...
<?php 
...

					{
					    ...
					    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020november"; 
...

                        {
						    ...
						    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020november";  // Query

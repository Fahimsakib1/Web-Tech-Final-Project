...
<?php 
...

					{
					    ...
					    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020may"; 
...

                        {
						    ...
						    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020may";  // Query

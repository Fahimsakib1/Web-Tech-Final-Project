...
<?php 
...

					{
					    ...
					    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020january"; 
...

                        {
						    ...
						    $sql = "SELECT employeeid,employeename,salarymonth,salary,bonus,total FROM salary2020january";  // Query
